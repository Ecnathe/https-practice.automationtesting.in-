...
public class HomeConstants {
    ...
    public static final String CASH_ON_DELIVERY = "xpath://input[@id='payment_method_cod']";
    public static final String ORDER_DETAIL_RECEIVED = "xpath://h2[text()='Order Details']";
    //Fromulario checkout
